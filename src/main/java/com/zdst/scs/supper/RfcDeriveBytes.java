...
/**
 * Created by lxh on 2018/11/6.
 */
public class RfcDeriveBytes {
     ...
     */
    public RfcDeriveBytes(byte[] password, byte[] salt, int iterations) throws NoSuchAlgorithmException,
            InvalidKeyException {
        this.salt = salt;
     ...
     */
    public RfcDeriveBytes(String password, int saltSize, int iterations) throws NoSuchAlgorithmException,
     ...
     * @throws UnsupportedEncodingException
     */
    public RfcDeriveBytes(String password, int saltSize) throws NoSuchAlgorithmException, InvalidKeyException,
     ...
     */
    public RfcDeriveBytes(String password, byte[] salt, int iterations) throws InvalidKeyException,
