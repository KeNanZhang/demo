...
layui.define(['layer', 'form'], function(exports){
  ...
  var setIframe = function(editor, textArea, set){
    ...
    iframe.css({
      ...
      ,style = $(['<style>'
        ,'*{margin: 0; padding: 0;}'
        ,'body{color:#f5f5f5;padding: 10px; line-height: 20px; overflow-x: hidden; word-wrap: break-word; font: 14px Helvetica Neue,Helvetica,PingFang SC,Microsoft YaHei,Tahoma,Arial,sans-serif; -webkit-box-sizing: border-box !important; -moz-box-sizing: border-box !important; box-sizing: border-box !important;}'
  ...
  ,insertInline = function(tagName, attr, range){
    ...
    //zdst-Lwq 修改 ：就解决Ie11下图片上传无法显示问题
//    ,elem = document.createElement(tagName)  源代码
