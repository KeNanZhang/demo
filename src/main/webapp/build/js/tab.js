...
;
layui.define(["jquery", "element", "utils"], function (t) {
    var e = layui.jquery, i = layui.element, a = layui.utils, n = e(document), l = e(window), r = {
        page: "page",
        iframe: "iframe"
    }, c = function () {
        this.config = {elem: void 0, mainUrl: "/version/projectManage/projectList.html", renderType: "iframe", openWait: !0}, this.v = "1.0.4"
    };
    ...
    var o = {
        ...
        tabAdd: function (t) {
            var e = this, a = e._config, n = void 0, l = (t = t || {
                    id: (new Date).getTime(),
                    title: "新标签页",
                    icon: "fa-file",
                    url: "404.html"
                }).title, c = t.icon, o = t.url, s = t.id;
